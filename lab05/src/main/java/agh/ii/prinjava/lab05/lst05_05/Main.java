...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        demo7();
        demo8();
        /** To compute the union, intersection, and difference of two sets using just the methods of the Set interface and without using loops, you can use the following methods:

         union: Set.addAll() method can be used to add all elements of one set to another. */
        ...
        /** intersection: Set.retainAll() method can be used to retain only the elements that are present in both sets.*/

        Set<Integer> set3 = new HashSet<>(Arrays.asList(1, 2, 3));
        Set<Integer> set4 = new HashSet<>(Arrays.asList(3, 4, 5));
        Set<Integer> intersectionSet = new HashSet<>(set3);
        intersectionSet.retainAll(set4);
        System.out.println("Intersection of set3 and set4: " + intersectionSet); // output: [3]

        /** difference: Set.removeAll() method can be used to remove all the elements of one set that are present in another set.*/
        Set<Integer> set5 = new HashSet<>(Arrays.asList(1, 2, 3));
        Set<Integer> set6 = new HashSet<>(Arrays.asList(3, 4, 5));
        Set<Integer> differenceSet = new HashSet<>(set5);
        differenceSet.removeAll(set6);
        System.out.println("Difference of set5 and set6: " + differenceSet); // output: [1, 2]
